...
RESOURCES_TOP_DIR=$USER_HOME/AirQualityMonitor
WD=`pwd`
...
success "\nSuccess!"
warning "For first time installations, please --reboot-- for hardware changes to take effect.\n"
warning "This library is installed for python 3 *only* make sure to use \"python3\".
